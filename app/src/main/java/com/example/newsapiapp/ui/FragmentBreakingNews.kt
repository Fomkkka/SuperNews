...
class FragmentBreakingNews : Fragment(), ItemClicklistner, MenuProvider{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as AppCompatActivity).supportActionBar?.setTitle("Термінові новини")
        ...
        val catlistener = View.OnClickListener {
            ...
            when (it.id){
                ...
                R.id.sportsImage->{
                    ...
                    (activity as AppCompatActivity).supportActionBar?.setTitle("Спорт")
                ...
                R.id.techImage->{
                    ...
                    (activity as AppCompatActivity).supportActionBar?.setTitle("ІТ")
                ...
                R.id.businessImage->{
                    ...
                    (activity as AppCompatActivity).supportActionBar?.setTitle("Бізнес")
...
// GOING TO ANOTHER FRAGMENT
    ...
    override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) {
        ...
        searchView.queryHint = "Пошук новин"
